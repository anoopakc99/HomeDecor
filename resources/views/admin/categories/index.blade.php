    ...
    <div class="card">
        <div class="card-header flex flex-col md:flex-row justify-between items-center p-6 border-b border-slate-100 gap-4">
            ...
            <div class="flex items-center gap-4 w-full md:w-auto">
                ...
                <a href="{{ route('admin.categories.create') }}" class="btn btn-primary whitespace-nowrap">
...
@push('scripts')
    <script>
        $(document).ready(function () {
            ...
            // Image Preview Logic
            $(document).on('mouseenter', '.category-thumbnail', function (e) {
            ...
            $(document).on('mousemove', '.category-thumbnail', function (e) {
                const $popover = $('#image-preview-popover');
            ...
            $(document).on('mouseleave', '.category-thumbnail', function () {
            ...
            // Pagination Handling
            $(document).on('click', '#categories-table-container .pagination a', function (e) {
                e.preventDefault();
                let page = $(this).attr('href').split('page=')[1];
                let query = $('#category-search').val();
                fetchCategories(query, page);
            });

            function fetchCategories(search, page) {
                $.ajax({
